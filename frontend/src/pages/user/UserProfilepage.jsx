    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
          <div className={`${activeTab === 'overview' ? 'block' : 'hidden md:block'} lg:col-span-1`}>
            <div className="bg-white rounded-2xl shadow-lg border border-purple-100 sticky top-6">
              {/* Header */}
                      ...
                      {isEditing ? (
                        <div className="relative">
                          <input
                            ...
                            className="w-full rounded-xl border-gray-200 bg-white px-4 py-2.5 text-sm
                              focus:border-purple-500 focus:ring-purple-500 
                              group-hover:border-purple-300 transition-colors"
                            placeholder={`Enter your ${key.toLowerCase()}`}
                          />
                          <span className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 group-hover:text-purple-500">
                            {getFieldIcon(key)}
                          </span>
                        </div>
                      ) : (
                        <div className="relative">
                          <div className="flex items-center bg-gray-50 rounded-xl px-4 py-2.5 group-hover:bg-purple-50/50 transition-colors">
                            <span className="mr-3 text-gray-400 group-hover:text-purple-500">
                              {getFieldIcon(key)}
                            </span>
